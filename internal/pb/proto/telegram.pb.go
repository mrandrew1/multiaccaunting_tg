...
type GetSessionStateResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Текущее состояние сессии: "PENDING", "READY" или "CLOSED".
...
func (x *GetSessionStateResponse) GetState() string {
...
const file_proto_telegram_proto_rawDesc = "" +
	...
	"\x05state\x18\x01 \x01(\tR\x05state2\xdf\x03\n" +
	...
	"\x11SubscribeMessages\x12'.pact.telegram.SubscribeMessagesRequest\x1a\x1c.pact.telegram.MessageUpdate0\x01\x12`\n" +
	"\x0fGetSessionState\x12%.pact.telegram.GetSessionStateRequest\x1a&.pact.telegram.GetSessionStateResponseB\x1eZ\x1cpact-telegram/internal/pb;pbb\beditionsp\xe8\a"
...
var file_proto_telegram_proto_goTypes = []any{
	...
	(*GetSessionStateRequest)(nil),   // 8: pact.telegram.GetSessionStateRequest
	(*GetSessionStateResponse)(nil),  // 9: pact.telegram.GetSessionStateResponse
}
var file_proto_telegram_proto_depIdxs = []int32{
	...
	8, // 4: pact.telegram.TelegramService.GetSessionState:input_type -> pact.telegram.GetSessionStateRequest
	...
	9, // 9: pact.telegram.TelegramService.GetSessionState:output_type -> pact.telegram.GetSessionStateResponse
